...
static void MX_LTDC_Init(void)
{
  ...
  /*
   * Framebuffer SDRAM của STM32F429I-DISCO.
   * Địa chỉ này trước đó test đỏ đã chạy.
   */
  HAL_LTDC_SetAddress(&hltdc, 0xD0000000U, 0);

  /*
   * Bật LCD panel. Nếu để DisplayOff() dễ trắng/đen màn.
   */
  LcdDrv->DisplayOn();
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2|BUZZER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12|GPIO_PIN_13, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, HCSR04_TRIG_Pin|LED3_SCAN_Pin|LED4_ALERT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI5_NCS_Pin BUZZER_Pin */
  GPIO_InitStruct.Pin = SPI5_NCS_Pin|BUZZER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : HCSR04_TRIG_Pin LED3_SCAN_Pin LED4_ALERT_Pin */
  GPIO_InitStruct.Pin = HCSR04_TRIG_Pin|LED3_SCAN_Pin|LED4_ALERT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
